...
#define R1_TAB    LT(_R1, KC_TAB)
#define R1_BSLS   LT(_R1, KC_BSLS)
#define R1_LBRC   LT(_R1, KC_LBRC)
#define MODS_RBRC LT(_MODS, KC_RBRC)

const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {

	[_BASE] = LAYOUT(
		KC_GRV     , KC_1       , KC_2       , KC_3       , KC_4       , KC_5       , KC_6       , KC_7       , KC_8       , KC_9       , KC_0       , KC_MINS    , KC_EQL     , KC_BSPC    , KC_MUTE     ,
		R1_TAB     , KC_Q       , KC_W       , KC_E       , KC_R       , KC_T       , KC_Y       , KC_U       , KC_I       , KC_O       , KC_P       , R1_LBRC    , MODS_RBRC  , R1_BSLS    , MO(_CONTROL),
		LCTL_ESC   , KC_A       , KC_S       , KC_D       , KC_F       , KC_G       , KC_H       , KC_J       , KC_K       , KC_L       , RALT_SEMI  , RCTL_QUOT  , KC_ENT                  , KC_VOLU     ,
		KC_LSFT    , KC_Z       , KC_X       , KC_C       , KC_V       , KC_B       , KC_N       , KC_M       , KC_COMM    , KC_DOT     , KC_SLSH    , XXXXXXX    , KC_RSFT    , KC_UP      , KC_VOLD     ,
		MO(_L1)    , MO(_R1)    , MO(_MODS)  , KC_SPC                                                                      , MO(_R1)    , MO(_L1)    , XXXXXXX    , KC_LEFT    , KC_DOWN    , KC_RIGHT   ),
	...
	[_SIMPLE] = LAYOUT(
		KC_GRV     , KC_1       , KC_2       , KC_3       , KC_4       , KC_5       , KC_6       , KC_7       , KC_8       , KC_9       , KC_0       , KC_MINS    , KC_EQL     , KC_BSPC    , KC_MUTE     ,
		KC_TAB     , KC_Q       , KC_W       , KC_E       , KC_R       , KC_T       , KC_Y       , KC_U       , KC_I       , KC_O       , KC_P       , KC_LBRC    , KC_RBRC    , KC_BSLS    , MO(_CONTROL),
		LCTL_ESC   , KC_A       , KC_S       , KC_D       , KC_F       , KC_G       , KC_H       , KC_J       , KC_K       , KC_L       , KC_SCLN    , KC_QUOT    , KC_ENT                  , KC_VOLU     ,
		KC_LSFT    , KC_Z       , KC_X       , KC_C       , KC_V       , KC_B       , KC_N       , KC_M       , KC_COMM    , KC_DOT     , KC_SLSH    , XXXXXXX    , KC_RSFT    , KC_UP      , KC_VOLD     ,
		MO(_L1)    , MO(_R1)    , MO(_MODS)  , KC_SPC                                                                      , MO(_R1)    , MO(_L1)    , XXXXXXX    , KC_LEFT    , KC_DOWN    , KC_RIGHT   ),
	...
	[_L1] = LAYOUT(
		...
		KC_LGUI    , KC_LGUI    , KC_2       , KC_1       , KC_0       , KC_9       , KC_LEFT    , KC_DOWN    , KC_UP      , KC_RIGHT   , KC_DEL     , KC_RGUI    , _______                 , _______     ,
    ...
    [_CONTROL] = LAYOUT(
		...
		DM_RSTP    , _______    , _______    , DM_REC2    , DM_PLY2    , _______    , _______    , _______    , _______    , _______    , _______    , _______    , _______    , _______    , _______     ,
		_______    , _______    , _______    , DM_REC1    , DM_PLY1    , _______    , _______    , _______    , _______    , _______    , _______    , _______    , _______                 , _______     ,
		_______    , _______    , _______    , _______    , _______    , _______    , _______    , _______    , _______    , _______    , _______    , _______    , _______    , _______    , _______     ,
